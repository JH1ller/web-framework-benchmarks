...
from flaskblog.forms import RegistrationForm, LoginForm, UpdateProfileForm, PostForm
from flaskblog.models import User, Post
from flask_login import login_user, current_user, logout_user, login_required
from sqlalchemy import create_engine

dbraw_engine = create_engine('sqlite:///site.db', connect_args={}, pool_reset_on_return=None)
...
def test_post():
    ...
    if form.validate():
        ...
        response = make_response(b'success')
        return response
    response = make_response(b'failure')
    return response